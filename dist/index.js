...
const generateTags = __nccwpck_require__(8007);
const gitCommands = __nccwpck_require__(4310);
...
const { version } = __nccwpck_require__(4760);
...
"use strict";
module.exports = JSON.parse('{"name":"@gh-stats/reporter","description":"gh-stats reporter package","main":"index.js","author":"Bartosz Gałek","repository":"git://github.com/gh-stats-app/reporter.git","license":"ISC","scripts":{"test":"jest"},"devDependencies":{"eslint":"^8.14.0","eslint-plugin-jest":"^26.1.5","jest":"^27.5.1","nock":"^13.2.4"},"version":"1.0.6"}');
